<template>
<div id="editModal" ref="editModal" class="modal fade" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <input id="price" type="number" min="0" class="form-control" v-model.number="editProduct.price"
                                placeholder="請輸入售價">
                        </div>
                    </div>
                    <hr>
                    <div class="form-group">
                        ...
                        <textarea id="description" type="text" class="form-control" v-model="editProduct.description"
                                placeholder="請輸入產品描述">
                        </textarea>
                    </div>
                    <div class="form-group">
                        <label for="content">說明內容</label>
                        <textarea id="description" type="text" class="form-control"  v-model="editProduct.content"
                                placeholder="請輸入說明內容">
                        </textarea>
                    </div>
                    <div class="form-group">
                        <div class="form-check">
                        <input id="is_enabled" class="form-check-input" type="checkbox"   v-model="editProduct.is_enabled"
