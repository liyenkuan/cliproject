       ...
       <div class="row">
         ...
         <div class="col-sm-8">
           <div class="form-group">
             ...
             <input id="Mtitle" type="text" class="form-control" placeholder="請輸入標題" v-model="addProduct.title">
           </div>
           <div class="row">
             <div class="form-group col-md-6">
               <label for="Mcategory">分類</label>
               <input id="Mcategory" type="text" class="form-control" v-model="addProduct.category"
                      placeholder="請輸入分類">
             </div>
             <div class="form-group col-md-6">
               <label for="price">單位</label>
               <input id="Munit" type="text" class="form-control" placeholder="請輸入單位" v-model="addProduct.unit" >
             </div>
           </div>
           <div class="row">
             <div class="form-group col-md-6">
